...
@onready var action_slots = %"Action Bar"
...
func _input(_event):
	...
	if Input.is_action_just_pressed("INVENTORY"):
		inventory_ui.populate(player.inventory)
		inventory_ui.toggle_visible()
		action_slots.toggle_visible()
...
func handle_mouse_pos():
	...
	interact_square.global_position = tile_map.map_to_local(local_mouse_pos)
